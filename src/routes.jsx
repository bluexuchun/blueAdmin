...
import HotCityListPage from './pages/HotCityListPage';
import HotCityEditPage from './pages/HotCityEditPage';
const autoGeneratedRoutes = [{
  ...
  path: 'hotCityListPage',
  childRoutes: [],
  component: HeaderAsideFooterResponsiveLayout,
  indexRoute: {
    component: HotCityListPage
  }
},{
  path: 'hotCityEditPage/:cityId',
  childRoutes: [],
  component: HeaderAsideFooterResponsiveLayout,
  indexRoute: {
    component: HotCityEditPage
  }
}, {
  path: '/home',
  childRoutes: [{
